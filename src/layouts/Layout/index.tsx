...
export default function Layout() {
  ...
  // variable: 기억력 검사 클래스 //
  const memoryTestClass = pathname === '/memory-test' ? 'navigation-item active' : 'navigation-item';

  // variable: 집중력 검사 클래스 //
  const concentrationTestClass = pathname === '/concentration-test' ? 'navigation-item active' : 'navigation-item';

  // event handler: My Content 클릭 이벤트 처리 //
  const onMyContentClickHanlder = () => {
  ...
  return (
    <div id='layout-wrapper'>
      <div id='top-bar'>
        ...
        <div className='my-content' onClick={onMyContentClickHanlder}>
          {showMyContent &&
