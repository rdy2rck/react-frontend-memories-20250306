      ...
      <div className='write-container'>
        ...
        <div className='contents-container'>
          ...
          <div className='input-row-box'>
            ...
            <div className={sunContentClass} onClick={() => onWeatherChangeHandler('맑음')}><div className={sunIconClass}></div>맑음</div>
            <div className={cloudContentClass} onClick={() => onWeatherChangeHandler('흐림')}><div className={cloudIconClass}></div>흐림</div>
            <div className={rainContentClass} onClick={() => onWeatherChangeHandler('비')}><div className={rainIconClass}></div>비</div>
            <div className={snowContentClass} onClick={() => onWeatherChangeHandler('눈')}><div className={rainIconClass}></div>눈</div>
            <div className={fogContentClass} onClick={() => onWeatherChangeHandler('안개')}><div className={fogIconClass}></div>안개</div>
          </div>
          <div className='input-row-box'>
            <div className='title'>기분</div>
            <div className='content' onClick={() => onFeelingChangeHandler('행복')}><div className='feeling-icon happy'></div>행복</div>
            <div className='content' onClick={() => onFeelingChangeHandler('즐거움')}><div className='feeling-icon funny'></div>즐거움</div>
            <div className='content' onClick={() => onFeelingChangeHandler('보통')}><div className='feeling-icon normal'></div>보통</div>
            <div className='content' onClick={() => onFeelingChangeHandler('슬픔')}><div className='feeling-icon sad'></div>슬픔</div>
            <div className='content' onClick={() => onFeelingChangeHandler('분노')}><div className='feeling-icon angry'></div>분노</div>
          </div>
